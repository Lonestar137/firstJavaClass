/*
   ...
   Function:  Simple Java application to demonstarte the behavior of different data types,
                        arithmetic, concatenation, and output of results.
                        
   Programmed By:  Garrett Jones, student (August 12, 2019)
   
   Code Taken From: "Java Programming (Fourth Edition by Joyce Farrell, Figure 2-26, page 61)

*/

public class P1_Garrett
{
